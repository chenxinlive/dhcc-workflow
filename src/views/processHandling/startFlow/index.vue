  ...
  <container type="ghost">
    <div class="theme-tab-container">
      ...
      <div class="card-box">
        ...
        >
          <icon name="inbox" style="margin-top: 30px;"></icon>
          <span>没有表单类型</span>
        </div>
      </div>
    </div>
    ...
    methods: {
      ...
      getCommonList() {
        getStartList({ keyword: this.keyword }).then((res) => {
          if (res.code === 200) {
            this.commonList = res.data.commProceList;
            this.processList=res.data.flowList;
            this.commonListCopy = res.data.commProceList;
          } else {
          ...
          .then((res) => {
            if (res.code == '200') {
              ...
              if (res.data == '' || res.data == undefined) {
                ...
                const mapJson = JSON.parse(res.data.mapJson);
