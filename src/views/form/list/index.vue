    ...
    <div class="theme-tab-container">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane v-for="item in tabList" :key="item.id" :name="item.id + ''" :label="item.name">
          ...
          <div v-else class="card-box-empty"  style="text-align: center">
        ...
        <el-table-column label="操作" align="center" >
          <template slot-scope="scope">
            <div  class="operation-btn">
              <el-button icon="el-icon-edit-outline" type="text" @click="edit(scope.row)">设计</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async getFormSortData() {
        const data = (await formSortList()).data;
        if (data.length) {
          this.tabList = data;
