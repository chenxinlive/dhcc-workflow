  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
          <h2>Z6-BPM</h2>
          <p>
              z6-BPM工作流系统，遵循BPMN2.0协议，基于Activiti7进行开发，前后端分离。支持多种审批动作，比如会签、加签、退回、驳回等。支持多种处理规则，比如按人员、角色、岗位、部门等。内置流程设计器、表单设计器，支持可视化业务流程配置以及热发布。
          </p>
          <p>
              <el-button
                      type="primary"
                      ...
                      icon="el-icon-cloudy"
                      plain
                      @click="goTarget('https://gitee.com/z6bpm/z6-bpm')"
              >访问Z6-BPM码云</el-button
              >
              <el-button
                      size="mini"
                      icon="el-icon-s-home"
                      plain
                      @click="goTarget('http://49.233.61.31:8088/')"
              >访问内部版演示环境</el-button
              >
          </p>
          <h2>技术支持QQ群：234707986</h2>
          <h2>商务合作：13331002404，15864031207 微信同</h2>
      </el-col>
        <el-col :sm="24" :lg="12" style="padding-left: 50px">
            ...
            <el-row>
                <el-col :span="6">
                    <h4>后端技术</h4>
                    <ul>
                        <li>后端： Spring Boot、Spring Cloud Alibaba</li>
                        <li>注册中心：Nacos</li>
                        <li>权限认证：Security、Jwt、Redis</li>
                        <li>流量控制：Sentinel</li>
                        <li>分布式事务：Seata（AT）</li>
                        <li>链路：SkyWalking</li>
                    </ul>
                </el-col>
                <el-col :span="6">
